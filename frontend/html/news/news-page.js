  ...
  constructor() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div>
        ...
        <footer class="container" style="border-top: 1px solid var(--dark); margin-top: 50px">
          <div class="flex justify-between header">
            <a href="index.html">
              <img class="logo" src="../assets/images/logo.png" />
            </a>
            <div style="display: flex; gap: 10px; flex-direction: column">
              <div style="display: flex; justify-items: items; gap: 10px">
                <img style="width: 20px; height: 20px" src="../assets/icons/pin.svg" />
                <p style="font-size: small; font-weight: var(--semi-bold)">
                  Сүхбаатар дүүрэг 6-р хороо , бага тойруу , Ж . Самбуугийн гудамж 6 тоот
                </p>
              </div>
              <div style="display: flex; justify-items: center; gap: 10px">
                <img style="width: 20px; height: 20px" src="../assets/icons/phone.svg" />
                <p style="font-size: small; font-weight: var(--semi-bold)">
                  9909-3223
                </p>
              </div>
              <div style="display: flex; justify-items: center; gap: 10px">
                <img style="width: 20px; height: 20px" src="../assets/icons/mail.svg" />
                <p style="font-size: small; font-weight: var(--semi-bold)">
                  info@memobox.mn
                </p>
              </div>
